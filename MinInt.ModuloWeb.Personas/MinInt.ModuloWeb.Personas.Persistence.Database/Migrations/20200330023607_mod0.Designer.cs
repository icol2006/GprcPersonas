...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinInt.ModuloWeb.Personas.Domain.Permisos", b =>
                {
                    ...
                    b.Property<int?>("SISTEMAID_SISTEMA")
                        .HasColumnType("int");

                    b.HasKey("ID_PERMISO");

                    b.HasIndex("SISTEMAID_SISTEMA");

                    b.ToTable("PERMISOS");
                });

            modelBuilder.Entity("MinInt.ModuloWeb.Personas.Domain.PermisosSistema", b =>
                {
            ...
            modelBuilder.Entity("MinInt.ModuloWeb.Personas.Domain.PersonasSistemas", b =>
                {
                    ...
                    b.HasKey("ID_PER", "ID_PERMISOS_SISTEMA");
            ...
            modelBuilder.Entity("MinInt.ModuloWeb.Personas.Domain.Sistemas", b =>
                {
                    ...
                    b.Property<int?>("PERSONAID_PER")
                        .HasColumnType("int");

                    b.HasKey("ID_SISTEMA");

                    b.HasIndex("PERSONAID_PER");
            ...
            modelBuilder.Entity("MinInt.ModuloWeb.Personas.Domain.Permisos", b =>
                {
                    b.HasOne("MinInt.ModuloWeb.Personas.Domain.Sistemas", "SISTEMA")
                        .WithMany("PERMISOS")
                        .HasForeignKey("SISTEMAID_SISTEMA");
                });
            ...
            modelBuilder.Entity("MinInt.ModuloWeb.Personas.Domain.PersonasSistemas", b =>
                {
                    ...
                    b.HasOne("MinInt.ModuloWeb.Personas.Domain.PermisosSistema", "PERMISOSSISTEMA")
                        .WithMany()
